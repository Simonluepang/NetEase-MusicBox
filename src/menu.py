    ...
    def start(self):
        ...
        while True:
            ...
            # 加载收藏歌曲
                ...
                self.stack.append([datatype, title, datalist, offset, index])
                self.datatype = 'songs'
                self.title = 'NetEase Music > Collection'
